...
const PT_BR_MAP: Record<string, string> = {
  ...
  form_password_pwned:
    'Essa senha apareceu em vazamentos publicos. Use uma senha unica e forte (sugestao: combine palavras + numeros, ex.: "gestor-azul-corte-9742").',
...
// Algumas formatacoes especificas por paramName quando o code e generico.
 ...
 * 1) Tenta mapear pelo code + paramName especificos (ex. email vs senha).
 * 2) Tenta mapear so pelo code.
 * 3) Cai na longMessage do servidor (ingles).
 * 4) Cai no fallback final.
 */
